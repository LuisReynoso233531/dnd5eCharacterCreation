...
class StatsDialogs {
          ...
          return AlertDialog(
            ...
            content: SizedBox(
              ...
              child: validFeats.isEmpty
                  ? const Text("You don't have any valid feats to choose from.")
                  : ListView.builder(
                      shrinkWrap: true,
        ...
        builder: (context, scrollController) => Padding(
          ...
          child: ListView(
            ...
            children: [
              ...
              Text(
                feat['desc'] ?? "Description not available.",
                style: const TextStyle(fontSize: 16, height: 1.5),
              ),
              const SizedBox(height: 20),
              if (feat['effects_desc'] is List &&
                  (feat['effects_desc'] as List).isNotEmpty) ...[
                const SizedBox(height: 8),
                const Text(
                  "Effects:",
  ...
  // ── MÉTODO MODIFICADO Y OPTIMIZADO ──
  static List<String>? _detectStatChoice(Map<String, dynamic> feat) {
    ...
    // Juntamos todo el texto del dote en minúsculas para buscar patrones
  ...
  static void _showFeatStatChoiceDialog(
    BuildContext context,
    CreateCharacterViewModel vm,
    int level,
